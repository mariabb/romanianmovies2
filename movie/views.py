...
def home(request):
    searching = request.GET.get('searchMovie')
    if searching:
        movies = Movie.objects.filter(title__icontains=searching)
    else:
        movies = Movie.objects.all()
    return render(request, 'home.html',	{'searching':searching, 'movies': movies})
